...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav  sidebar sidebar-dark accordion" style="background-color:#198754;" id="accordionSidebar">
			...
			<!-- Nav Item - Charts -->
            <li class="nav-item">
                <a class="nav-link" href="presenca.html">
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <div class="collapse-divisor"></div>
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
									...
									<option id="CRM00000" value="ADMINISTRATIVO/ENFERMEIRO">CRM00000</option>
									<option id="CRM77344" value="ADRIANA MARTINS MONTEIRO DE CASTRO">CRM77344</option>
									<option id="CRM37969" value="ADRIANO OLIVIERI BRITO">CRM37969</option>
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
									...
									<!-- seleção do Andar -->
									<select class="form-select shadow-sm" id="andar" name="andar" required="" aria-label="Default select example">
									
									<option id="erro" value="">Selecione um andar...</option>
									<option name="andar" value="6">6</option>
									
									</select>
									
									<!-- seleção da sala -->
									<select class="form-select shadow-sm mt-2" id="sala" name="sala" required="required" aria-label="Default select example">
									...
									<!-- seleção da mesa -->
									<select class="form-select shadow-sm mt-2" id="mesa" name="mesa" required="required" aria-label="Default select example">
									...
									<!-- seleção do turno -->
									<select class="form-select shadow-sm mt-2" id="turno" name="turno" required="required" aria-label="Default select example">
										<option id="erro" value="">Selecione um turno...</option>
										
										<option name="turno" value="MANHA">MANHA</option>
										...
										<option name="turno" value="12H">12H</option>


										<option name="turno" value="14H">14H</option>

									</select>
									
									<input type="hidden" id="ti" name="ti" value="felipe"></input>
									  <button type="submit" form="inserir" id="salvarPresenca" name="salvarPresenca" class="col-12 mt-2 shadow-sm btn btn-success bg-gradient">salvar</button>
									  <script>
										$(document).ready(function() {
                        ...
                        <div class="col">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body table-responsive">
                                    <table id="presenca" class="table bg-secondary bg-gradient rounded text-white"> 
									  <thead>
										<tr>
    ...
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.0.1/dist/js/bootstrap.bundle.min.js" integrity="sha384-gtEjrD/SeCtmISkJkNUaaKMoLD0//ElJ19smozuHV6z3Iehds+3Ulb9Bn9Plx0x4" crossorigin="anonymous"></script>    <!-- Bootstrap core JavaScript-->
